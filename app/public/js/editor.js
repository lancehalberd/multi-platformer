...
var brushList = [
    ...
    new PointEntityBrush(new PointSpawner(getCreatureHauntedMask(0, 0, mainCharacter), 0)),
    new PointEntityBrush(new PointSpawner(getCreatureWraithHound(0, 0, mainCharacter), 0)),
